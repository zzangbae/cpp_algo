    ...
    for(int i = 0; i < n; i++) {
        for(int j = i + 1; j < n; j++) {
            for(int k = j + 1; k < n; k++) {
                ...
                int a_2 = (arr[i] % 10000) / 1000;   // 천의 자리
                int a_3 = (arr[i] % 1000) / 100;     // 백의 자리
                int a_4 = (arr[i] % 100) / 10;       // 십의 자리
                int a_5 = (arr[i] % 10);             // 일의 자리

                int b_2 = (arr[j] % 10000) / 1000;   // 천의 자리
                int b_3 = (arr[j] % 1000) / 100;     // 백의 자리
                int b_4 = (arr[j] % 100) / 10;       // 십의 자리
                int b_5 = (arr[j] % 10);             // 일의 자리

                int c_2 = (arr[k] % 10000) / 1000;   // 천의 자리
                int c_3 = (arr[k] % 1000) / 100;     // 백의 자리
                int c_4 = (arr[k] % 100) / 10;       // 십의 자리
                int c_5 = (arr[k] % 10);             // 일의 자리
